...
mixin _$DownloadState {
  bool get isLoading =>
      throw _privateConstructorUsedError; // if the data is availble without any exception then this variable will have
// list of donwloads
  List<Downloads> get downloads => throw _privateConstructorUsedError;
  Option<Either<CoreCommanFailures, List<Downloads>>>
    ...
    return _then(_value.copyWith(
      ...
      downloadsFailureOrSuccesOption: downloadsFailureOrSuccesOption == freezed
          ...
          : downloadsFailureOrSuccesOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<CoreCommanFailures, List<Downloads>>>,
    ));
  }
}
...
class _$_DownloadState implements _DownloadState {
  ...
  @override // if the data is availble without any exception then this variable will have
// list of donwloads
  final List<Downloads> downloads;
  @override
  final Option<Either<CoreCommanFailures, List<Downloads>>>
      downloadsFailureOrSuccesOption;

  @override
  String toString() {
    return 'DownloadState(isLoading: $isLoading, downloads: $downloads, downloadsFailureOrSuccesOption: $downloadsFailureOrSuccesOption)';
  }
...
abstract class _DownloadState implements DownloadState {
  const factory _DownloadState(
      ...
      required List<Downloads> downloads,
      required Option<Either<CoreCommanFailures, List<Downloads>>>
          downloadsFailureOrSuccesOption}) = _$_DownloadState;
